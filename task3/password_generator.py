...
heading_label = tk.Label(window, text="Password Generator", font=("Helvetica", 18, "bold"),bg="floralwhite")
heading_label.grid(pady=10, column=1, columnspan=10)
    
name_label = tk.Label(window, text="Name:", font=("Helvetica", 12), bg="antiquewhite")
name_label.grid(row=1, column=1, padx=10, pady=15, sticky="e")

name_entry = tk.Entry(window, width=30)
name_entry.grid(row=1, column=2, padx=10, pady=15)

length_label = tk.Label(window, text="Password Length:", font=("Helvetica", 12), bg="antiquewhite")
...
complexity_label = tk.Label(window, text="Complexity Level:", font=("Helvetica", 12), bg="antiquewhite")
complexity_label.grid(row=3, column=1, padx=10, pady=15, sticky="e")

complexity_var = tk.StringVar()
complexity_var.set("low")

complexity_radio_low = tk.Radiobutton(window, text="Low", variable=complexity_var, value="low", bg="antiquewhite")
complexity_radio_low.grid(row=3, column=2, padx=10, pady=15, sticky="w")

complexity_radio_high = tk.Radiobutton(window, text="High", variable=complexity_var, value="high", bg="antiquewhite")
complexity_radio_high.grid(row=4, column=2, padx=10, pady=15, sticky="w")

generatePassword_button = tk.Button(window, text="Generate Password", command=generatePassword_button_click, font=("Helvetica", 12), bg="floralwhite" )
generatePassword_button.grid(row=5, column=1, columnspan=19, padx=10, pady=10)

result_label = tk.Label(window, text="", wraplength=400, bg="floralwhite", font=("Helvetica", 12))
result_label.grid(row=6, column=1, columnspan=2, padx=10, pady=15)

accept_button = tk.Button(window, text="Accept", state=tk.DISABLED, command=accept_password, bg="lightskyblue")
accept_button.grid(row=7, column=1, padx=70, pady=25)

reject_button = tk.Button(window, text="Reject", state=tk.DISABLED, command=reject_password, bg="red1", )
