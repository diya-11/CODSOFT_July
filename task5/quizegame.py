...
class Quiz:
    ...
    def buttons(self):
        ...
        width=13,bg="light yellow3",fg="black",font=("ariel",12,"bold"))
        next_button.place(x=350,y=380)
        
        submit_button = Button(gui, text="Submit", command=gui.destroy,
        width=10,bg="red", fg="white",font=("ariel",12," bold"))
...
gui = Tk()
gui.configure(bg="#BF3EFF")
gui.title("Quiz")
gui.geometry("850x450")
with open('./task5/qustions.json') as f:
    data = json.load(f)
